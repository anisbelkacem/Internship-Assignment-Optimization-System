...
public class StudentController {
    ...
    private StudentDto toDto(Student student) {
        return new StudentDto(
                ...
                student.getMainCourse() != null ? student.getMainCourse().getId() : null,
                student.getPrefCourse1() != null ? student.getPrefCourse1().getId() : null,
                student.getPrefCourse2() != null ? student.getPrefCourse2().getId() : null,
                student.getPrefCourse3() != null ? student.getPrefCourse3().getId() : null,
                student.isRegistred(),
                student.isOriented(),
                student.getAddress(),
